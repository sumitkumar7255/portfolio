    ...
    <div className="w-full lgl:w-1/2 flex flex-col gap-20">
      <div className="flex flex-col gap-5">
        ...
        <p className="text-base font-bodyFont leading-6 tracking-wide">
          ...
          mentored towards a successful career. Seeking a challenging position in a reputed
          organization where I can learn new skills expend my knowledge, and leverage my
          learnings.
